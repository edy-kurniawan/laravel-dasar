        ...
        <div id="resources" class="hero container py-5 my-5">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div class="col-10 col-sm-8 col-lg-6">
                    <img src="https://demo.templatesjungle.com/deliver/images/scooter.png"
        ...
        <div id="resources" class="container py-5 my-5">
            ...
            <div class="row row-cols-1 row-cols-md-2 align-items-md-center gx-5 py-5">
                <div class="col-md-7 d-flex flex-column align-items-start">
                    ...
                    <p class="feature-paragraph my-5">kami berkomitmen untuk menjadi jembatan yang mengantarkan impian
                        dan tujuan Anda ke seluruh penjuru dunia. Dengan jangkauan global dan layanan terpercaya.
                    </p>
                ...
                <div class="col-md-5">
                    <div class="row flex-column g-4 mt-3">
                        <div class="feature-post py-2 px-5">
                            ...
                            <p>Menyediakan layanan ekspedisi dengan jangkauan global yang luas, sehingga dapat
                                mengantarkan kiriman pelanggan ke hampir seluruh penjuru dunia.</p>
                        </div>

                        <div class="feature-post py-2 px-5">
                            <h4 class="py-3">Keamanan dan Keandalan</h4>
                            <p>Memberikan jaminan keamanan dan keandalan tinggi dalam pengiriman barang, dengan sistem
                                pelacakan yang canggih untuk memastikan barang tiba dengan selamat dan tepat waktu.</p>
                        </div>

                        <div class="feature-post py-2 px-5">
                            <h4 class="py-3">Kompetitif Harga</h4>
                            <p>Menawarkan tarif yang kompetitif dan transparan, tanpa mengorbankan kualitas layanan,
                                sehingga memberikan nilai tambah bagi pelanggan.</p>
                        </div>
            ...
            <div class="row py-5">
                <div class="col-md-3">
                    <div class="service-post py-5 px-5">
                        ...
                        <p>Pengiriman cepat dan tepat waktu, rekomendasi untuk kiriman yang membutuhkan pengantaran
                            ekspres sampai tujuan.</p>
                ...
                <div class="col-md-3">
                    <div class="service-post py-5 px-5">
                        ...
                        <p>Layanan khusus untuk mengirimkan barang berukuran besar dan berat, seperti peralatan
                            industri, mesin, atau barang proyek.</p>
                        <a href="#" class="icon-link">More info </a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="service-post py-5 px-5">
                        ...
                        <p>Konsultasi ahli dalam perencanaan dan implementasi solusi logistik sesuai dengan kebutuhan
                            bisnis pelanggan.</p>
                        <a href="#" class="icon-link">More info </a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="service-post py-5 px-5">
                        ...
                        <p>Penawaran opsi asuransi untuk melindungi kiriman dari kerusakan atau kehilangan selama proses
                            pengiriman.</p>
                        <a href="#" class="icon-link">More info </a>
                    </div>
                </div>
        ...
        <div id="contact" class="container py-5 my-5">
            ...
            <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5 ">
                ...
                <div class="col-md-7 action-column2 d-flex flex-column align-items-center py-5 px-5">
                    ...
                    <p class="action-paragraph text-center my-5 px-5 ">Hubungi kami untuk mendapatkan penawaran terbaik
                        untuk
                        pengiriman Anda.</p>
