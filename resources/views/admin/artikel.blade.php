...
<body class="hold-transition sidebar-mini">
                                    ...
                                    <table class="table" id="mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ url('thumbnail/'.$data->thumbnail) }}" alt=""
                                                        width="100px"></td>
                                                <td>
                                        ...
                                        <div class="modal-body">
                                            <form action={{ route('admin.store') }} method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input name="judul" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan judul">
                                                </div>
                                                <div class="form-group">
    ...
    <script>
        // dokumen yang pertama kali dijalankan saat halaman dibuka
        $(document).ready( function () {
            // id mytable diambil dari table yang ada di file index.blade.php
            $('#mytable').DataTable();
        } );
    </script>
