    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Membuat Website Sederhana Dengan Framework Laravel</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link text-center">
                <span class="brand-text text-center">ADMIN PANEL</span>
            </a>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{ route('artikel.create') }}" class="btn btn-primary float-right">Tambah Artikel <i
                                    ...
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ url('thumbnail/'.$data->thumbnail) }}" width="100px"></td>
                                                <td>
                                                    <form action="{{ route('artikel.destroy', $data->id)}}" method="post" class="d-inline">
                                                        @method('delete')
                                                        @csrf
                                                        <a href="/artikel/{{ $data->id }}/edit" class="btn btn-success">Edit <i
